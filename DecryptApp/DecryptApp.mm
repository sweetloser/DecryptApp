...
BOOL isdecrypted(void){
    ...
    NSString *decryptedPath = [documentPath stringByAppendingPathComponent:[[[NSBundle mainBundle] executablePath] lastPathComponent]];
    
    decryptedPath = [decryptedPath stringByAppendingString:@".decrypted"];
    
    NSFileManager *fm = [NSFileManager defaultManager];
    if ([fm fileExistsAtPath:decryptedPath isDirectory:NO]) {
        return YES;
    }
    return NO;
}
